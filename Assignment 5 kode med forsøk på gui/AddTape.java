 ...
 * @author Vidar
 */
public class AddTape extends javax.swing.JFrame {

    /**
     * Creates new form AddTape
     */
    public AddTape() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Add Tape");

        jToggleButton1.setText("Digital");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddTape.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
